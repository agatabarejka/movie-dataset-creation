# tests written by Keith Galli from https://github.com/KeithGalli/disney-data-science-tasks repo

import pytest

from money_conversion import money_to_float as money_conversion
